      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={submit} className="space-y-4">
            <div><Label>Transfer code</Label><Input value={form.transferCode} onChange={(e) => setForm({ ...form, transferCode: e.target.value.toUpperCase() })} placeholder="TRF-XXXXXXXX" required /></div>
